# ==============================
# FILE ORGANIZER - MASTER FILE 6.4
# CONSOLIDATION EDITION
# ==============================
# VERSION 6.4 NEW FEATURES (IN DEVELOPMENT):
...
# ✨ Tabbed Interface (organized UI with Organize, Search, Tools tabs)
# ✨ Recent Directories (quick access to last 10 used paths)
#
...
# VERSION & CONSTANTS
# ==============================
VERSION: str = "v6.4 Consolidation"
...
tab_groups = {
    "📂 Organize": ["By Extension", "Alphabetize", "IMG/DSC", "Smart Pattern", "Smart Pattern +", "Sequential Pattern"],
